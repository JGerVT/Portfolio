        ...
        <ParentSection sectionID="Footer" paddingY="70px" backgroundColor="black">
            <div className="flex flex-1">
                <div className="flex flex-1 h-[250px] justify-between">
                    <div className="flex items-start text-white space-x-4 cursor-pointer border-r ml-6 pr-20 border-gray-700">
                    ...
                    <div className="flex items-start text-gray-300 space-x-4 cursor-pointer ml-6">
                        <div className="mt-1 pl-2">
